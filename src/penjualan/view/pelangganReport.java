 ...
 * @author Lani
 */
public class pelangganReport extends javax.swing.JFrame {
    ...
    void loadData() {
        try {
            ...
            Logger.getLogger(pelangganReport.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
//---untuk menyatukan metode2 yang kita buat diatas supaya dapat berjalan secara teratur dan memanggilnya dengan mudah---///
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pelangganReport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pelangganReport().setVisible(true);
            }
        });
    }
